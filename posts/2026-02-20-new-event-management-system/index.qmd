---
title: "Introducing Bioconductor's New Event Management System"
description: |
...
- Automatic acknowledgment emails to applicants
...
1. **Access the Application Form**: Visit the Bioconductor event application form (link will be provided on the official Bioconductor website and community channels).

2. **Complete the Application**: Provide details about your proposed event, including:
   - Event type (workshop, training, conference, meetup, etc.)
   - Proposed date and location
   - Expected number of participants
   - Description of the event content and learning objectives
   - Information about organizers and instructors
   - Budget requirements (if requesting financial support)
...
4. **Review Process**: The Bioconductor community team will review your application and typically respond within two weeks with:
   - Approval and next steps for event planning
